		...
		<div id="list-distribuidor" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="title" title="${message(code: 'distribuidor.title.label', default: 'Title')}" />
				...
				<g:each in="${distribuidorInstanceList}" status="i" var="distribuidorInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${distribuidorInstance.id}">${fieldValue(bean: distribuidorInstance, field: "title")}</g:link></td>
			...
			<div class="pagination">
				<g:paginate total="${distribuidorInstanceCount ?: 0}" />
			</div>
		</div>
	</body>
</html>
